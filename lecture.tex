...
%     \newline
%     \onslide<2-> {
%         $\exists$ a valid red-black tree such that the path from root $\to$ leaf contains
%         exclusively \textib{black} nodes. This tree has a height $b$. $(1)$
%     }
%     \newline
%     \onslide<3-> {
%         Similarly, $\exists$ a valid red-black tree such that the path from root $\to$ leaf alternates
%         between \red and \textib{black} nodes. This tree has a height $2b$. $(2)$
%     }
%     \newline
%     \onslide<4-> {
%         Consider an arbitrary valid red-black tree of height $h$.
%     }
%     \newline
%     \onslide<5->{Then $b \leq h \leq 2b$ from $(1), (2)$. $(*)$}
%     \newline
%     \onslide<6->{There are $2^b - 1 \leq n$ nodes in the tree $\implies b \leq \log(n + 1)$.}
%     \newline
%     \onslide<7->{Then, from $(*)$ we get
%         \newline
%         \[
