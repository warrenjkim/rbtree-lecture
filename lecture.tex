...
\tikzset{
    ...
    empty/.style = {treenode, circle, white, draw=white, fill=white, text width=1.5em, very thin},
...
\begin{frame}{Applications}
    ...
    \begin{itemize}[label=$\to$]
        ...
        \item STL Data Structures (e.g. C++'s \textmtt{std::map}, Java's \textmtt{HashMap})
        \item Graph algorithm optimizations (for AI/ML)[e.g. K-mean clustering]
        \item Priority Queues (e.g. Range Queries)
    \end{itemize}
\end{frame}
...
\begin{frame}[fragile]{Depth Property}
    ...
    \begin{minipage}[t][0.6\textheight][c]{\linewidth}
        ...
        \only<2> {\depthtwo}
        \onslide<2> {\textbf{\textcolor{red}{Invalid}}}
        \vspace{1.1em}
        ...
        \begin{column}{.5\textwidth}
            \begin{center}
                \begin{tikzpicture}
                    ...
                    \tikzstyle{ured} = [red_node]
                    \tikzstyle{ublack} = [black_node]

                    \newcommand{\nx}{}
                    \newcommand{\setcolor}[3]{\ifthenelse{\insertslidenumber=#1}{\renewcommand{#2}{#3}}{}}
                    \newcommand{\setnumm}[2]{\ifthenelse{\equal{#2}{}}{}{#1}}
                    \setcolor{3}{\nx}{ured}
                    \setcolor{4}{\nx}{ublack}
...
\begin{frame}[fragile]{Case: Left-Right}
    ...
    \begin{minipage}[t][0.1\textheight][c]{\linewidth}
        \only<2-3> {\textbf{Left Rotation}}
        \only<4> {\textbf{Right Rotation}}
    \end{minipage}
    \begin{minipage}[t][0.6\textheight][c]{\linewidth}
    \only<1> {\lrbefore}
    \only<2> {\lrintermediateone}
    \only<3> {\lrintermediate}
    \only<4> {\lrafter}
    \end{minipage}
    \vspace{1em}
...
\begin{frame}{Resources}
    \begin{center}
        ...
        {\textmtt{\textcolor{blue}{\underline{https://github.com/warrenjkim/rbtree-lecture}}}}
    \end{center}
\end{frame}
