...
% ===== LEFT RIGHT INTERMEDIATE 1 =====
\newcommand{\lrintermediateone} {
    \begin{center}
        \begin{tikzpicture}
            [-,>=stealth',
            level 1/.style={sibling distance = 4cm, level distance = 1cm},
            ...
            child {
                ...
                child {
                    node [empty] {}
                    child {
                        node [red_node] {$5$} edge from parent [draw=none]
                        child {
                            node [black_node] {$3$}
                            child { node [sub] {$\cdots$} }
                            child { node [sub] {$\cdots$} }
                        }
                        child { node [empty] {} edge from parent [draw=none] }
                    }
                    child {
                        node [red_node] {$10$} edge from parent [draw=none]
                        child {
                            node [black_node] {$7$}
                            child { node [sub] {$\cdots$} }
                            child { node [sub] {$\cdots$} }
